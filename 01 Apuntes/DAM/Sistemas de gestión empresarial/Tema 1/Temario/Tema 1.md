...
| Funciones principales | - Recopilación de datos de distintas fuentes (ERP, CRM, bases de datos)<br>- Análisis de datos para detectar patrones y tendencias<br>- Visualización mediante dashboards y gráficos<br>- Informes y reporting para directivos y equipos<br>- Predicción y planificación de escenarios futuros     |
| Tipos de BI<br>       | - **Operativo**: análisis de datos diarios para mejorar procesos<br>- **Analítico**: análisis histórico y estratégico de tendencias<br>- **Predictivo**: modelos y algoritmos para anticipar resultados                                                                                            |
| Beneficios            | - Mejora la toma de decisiones basada en datos<br>- Detecta oportunidades de negocio y áreas de mejora<br>- Aumenta eficiencia y productividad<br>- Facilita planificación estratégica y predicción de tendencias<br>- Proporciona información clara y visual para distintos niveles de la empresa |
| Ejemplos populares    | Power BI, Tableau, Qlik Sense, SAP Analytics Cloud, Looker                                                                                                                                                                                                                                         |
